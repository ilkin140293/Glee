$( function(){
  ...
  $('.product-list__btn').on('click', function(){
    $('.product-list__filters').toggleClass('product-list__filters--visible');
  });

  $('.product-list2__btn').on('click', function(){
    $('.product-list2__filters').toggleClass('product-list2__filters--visible');
  });
